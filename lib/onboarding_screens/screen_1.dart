...
import 'package:project_wtf/onboarding_screens/screen_2.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 30),
            Text("Dispose Waste Responsibly",
            ...
            Text("Conveniently locate nearby recycling points and waste collection centers.",
              textAlign: TextAlign.center,
              style:TextStyle(
                  fontSize: 18,
                    ...
                    children: [
                     ...
                     Positioned(
                       child: ElevatedButton(
                           onPressed: (){
                             Navigator.push(context,
                                 MaterialPageRoute(builder: (context) => const Screen_2()));
                           },
